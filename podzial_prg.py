...
# Ścieżki
input_shp = "D:/GIS NCBR/PRG/PRG-punkty_adresowe_shp/nowe_prg_punktyadresowe_polska.gpkg"
output_dir = Path("prg-punktyadresowe_powiaty")
output_dir.mkdir(exist_ok=True)

# Nazwa kolumny, według której dzielimy plik
attribute_column = "TERYT_POW"  # zamień na swoją kolumnę
